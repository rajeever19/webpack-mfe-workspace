...
export default function App() {
  return (
    <Card elevation={4} style={{ borderRadius: 12, overflow: 'hidden', border: '1px solid #e0e0e0' }}>
      <Box style={{ backgroundColor: '#263238', padding: '20px 25px', display: 'flex', alignItems: 'center' }}>
      ...
      <CardContent style={{ padding: '30px 25px' }}>
        <Grid container spacing={5}>
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="h3" style={{ fontWeight: 800, color: '#263238' }}>92.4%</Typography>
            <LinearProgress variant="determinate" value={92.4} style={{ height: 10, borderRadius: 5, marginTop: 15, backgroundColor: '#ffebee' }} sx={{ '& .MuiLinearProgress-bar': { backgroundColor: '#b71c1c' } }} />
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="h3" style={{ fontWeight: 800, color: '#263238' }}>14</Typography>
            <Box mt={2.5} display="flex" flexWrap="wrap" gap={1}>
               ...
               <Chip label="APAC" style={{ fontWeight: 600, backgroundColor: '#e3f2fd', color: '#1565c0' }} />
            </Box>
          </Grid>
